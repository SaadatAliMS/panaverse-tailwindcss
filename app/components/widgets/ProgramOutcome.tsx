...
const ProgramOutcome = () => {
  return (
    <section className="mt-16 md:mt-28">
      <Wrapper>
        {/* flex-col shifts content on left side at top in mobile screen whereas flex-col-reverse shifts rightside content on top */}
        <div className="flex gap-x-8 items-center flex-col-reverse md:flex-row">
          ...
          <div className="flex-1">
            ...
            <p className="mt-4 text-slate-700 text-justify text-lg ">
            ...
            <div className="mt-6 grid grid-cols-2 gap-x-4 gap-y-4">
              {outcomePoints.map((item, i) => (
                <div key={i} className="flex items-center gap-x-2">
                  {/* in svg className=flex-shrink-0 added.see effect by removing it  */}
                  <svg
